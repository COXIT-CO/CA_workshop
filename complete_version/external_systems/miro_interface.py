...
from complete_version.use_cases.miro_use_cases import get_all_shapes_from_widgets, increment_voting_text
from complete_version.entities.miro_objects import Shape


class MiroApiClient:
    def __init__(self, base_url: str, auth_token: str, db_path: str = 'ids.json'):
